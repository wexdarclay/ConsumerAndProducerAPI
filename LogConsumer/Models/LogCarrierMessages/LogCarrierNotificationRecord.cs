namespace LogConsumer.Models.LogCarrierMessages
{
	public class LogCarrierNotificationRecord
	{
		...
		public string? carrier_notification_name_type { get; set; }
		public string? carrier_notification_description { get; set; }
		...
		public string? depedent_id { get; set; }
